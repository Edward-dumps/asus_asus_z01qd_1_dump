...
######################################################################################
	...
	cat /dev/block/platform/soc/1d84000.ufshc/by-name/asuskey3 > $SAVE_LOG_PATH/asuskey3.bin
############################################################################################
	# save battery health information
	cat /sdcard/.bh > $SAVE_LOG_PATH/charger_debug/bh.txt
############################################################################################
	# save debug report
...
#        dumpstate -q -d -z  -o $SAVE_LOG_PATH/bugreport
	...
	ls -alRZ /data >  $SAVE_LOG_PATH/dataSelinux.txt    
